...
def connect_database():
    ...
    query = 'select * from data where username=%s' # username already exist
    ...
    if row!= None:
        ...
        con.commit()
        con.close()
        messagebox.showinfo('Success','Registration succesfull') # Title and message
        clear()
...
signupButton = Button(frame,text='Signup',font = ('Open Sans',16,'bold'),fg='white',bg='firebrick1',activeforeground='white',activebackground='firebrick1',cursor='hand2',bd=0,width=17,command=connect_database)
signupButton.grid(row=10,column=0,pady=10)

alreadyaccount = Label(frame,text='Already have an account?',font=('Open Sans', 9,'bold'),fg='firebrick1',bg='white')
alreadyaccount.grid(row=11,column=0,sticky='w',padx=25,pady=10)

loginButton = Button(frame,text='Login',font = ('Open Sans',9,'bold underline'),fg='blue',bg='white',activeforeground='blue',activebackground='white',cursor='hand2',bd=0,command=login_page)
loginButton.place(x=174,y=404)
